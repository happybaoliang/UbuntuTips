...
%-----------------------------------------正文开始------------------------------
\include{chapter/chap1}								%第一章
\include{chapter/chap2}								%第二章
\include{chapter/chap3}								%第三章
%\include{chapter/chap4}							%第四章
%\include{chapter/chap5}							%第五章
%\include{chapter/chap6}							%第六章
%\include{chapter/chap7}							%第七章
%\include{chapter/chap8}							%第八章
%\include{chapter/chap9}							%第九章
%\addtocounter{chapter}{7}


%-----------------------------------------正文结束------------------------------
%\include{chapter/answer}							%习题答案
